...
$config = array(
     ...
     */
    'showerrors' => {{ .showerrors | yesno "true" "false" }},
    'errorreporting' => {{ .errorreporting | yesno "true" "false" }},
     ...
     */
    'debug.validatexml' => {{ .debug_validatexml | yesno "true" "false" }},
     ...
     */
    'auth.adminpassword' => '{{ .auth_adminpassword }}',
    'admin.protectindexpage' => {{ .admin_protectindexpage | yesno "true" "false" }},
    'admin.protectmetadata' => {{ .admin_protectmetadata | yesno "true" "false" }},
     ...
     *
     */
    'logging.level' => SimpleSAML_Logger::{{ .loggin_level }},
     ...
     */
    'enable.saml20-idp' => {{ .enable_saml20_idp | yesno "true" "false" }},
    'enable.shib13-idp' => {{ .enable_shib13_idp | yesno "true" "false" }},
    'enable.adfs-idp' => {{ .enable_adfs_idp | yesno "true" "false" }},
    'enable.wsfed-sp' => {{ .enable_wsfed_sp | yesno "true" "false" }},
    'enable.authmemcookie' => {{ .enable_authmemcookie | yesno "true" "false" }},
     ...
     */
    'session.duration' => {{ .session_durration }},
     ...
     */
    'session.cookie.domain' => {{ if .session_cookie_domain }}'{{ .session_cookie_domain }}'{{ else }}null{{ end }},
     ...
     */
    'session.cookie.secure' => {{ .session_cookie_secure | yesno "true" "false" }},

    /*
     * When set to FALSE fallback to transient session on session initialization
     * failure, throw exception otherwise.
     */
    'session.disable_fallback' => {{ .session_disable_fallback | yesno "true" "false" }},
     ...
     */
    'enable.http_post' => {{ .enable_http_post | yesno "true" "false" }},
     ...
     */
    'session.authtoken.cookiename' => '{{ .session_authtoken_cookiename }}',
    ...
    'language.default' => '{{ .language_default }}',
     ...
     */
    'language.cookie.name' => '{{ .language_cookie_name }}',
    'language.cookie.domain' => {{ if .language_cookie_domain }}'{{ .language_cookie_domain }}'{{ else }}null{{ end }},
    'language.cookie.path' => '{{ .language_cookie_path }}',
    'language.cookie.lifetime' => {{ .language_cookie_lifetime }},
